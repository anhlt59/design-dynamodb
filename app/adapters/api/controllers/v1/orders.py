...
from app.domain.models.orders import (
    CreateOrderInputDto,
    OrderOutputDto,
    PaginatedOrderInputDto,
    PaginatedOrderOutputDto,
)
...
@router.get("", response_model=PaginatedOrderOutputDto)
@inject
def list_user_orders(
    ...
    items, next_cursor = order_use_case.list_user_orders(user_id, params)
    return {
        "items": items,
        "limit": params.limit,
        "next": next_cursor,

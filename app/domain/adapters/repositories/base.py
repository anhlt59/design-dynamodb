...
class DynamoRepository[M: DynamoModel]:
    ...
    @property
    def transaction(self) -> TransactWrite | None:
        return self.__transaction

    @transaction.setter
    def transaction(self, value: TransactWrite | None):
    ...
    def _create(self, model: M, condition: Condition | None = None):
        ...
        self.transaction.save(model, condition=condition)
    ...
    def _update(
        ...
        self.transaction.update(model, actions=actions, condition=condition)
    ...
    def _delete(
        ...
        model = self.model_cls(hash_key=hash_key, range_key=range_key)
        self.transaction.delete(model, condition=condition)

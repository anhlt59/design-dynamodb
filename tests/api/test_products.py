...
from app.domain.adapters.unit_of_works import CategoryUnitOfWork, ProductUnitOfWork
from app.domain.adapters.use_cases import CategoryUseCase, ProductUseCase
from app.domain.models import Category

product_use_case = ProductUseCase(ProductUnitOfWork())
category_use_case = CategoryUseCase(CategoryUnitOfWork())
...
def test_create_product(test_client, dummy_brand, dummy_category):
    ...
    product_use_case.delete(rv.json()["id"])
    # invalid brand_id
